...
func TestExtract(t *testing.T) {
	...
	transformedData := dataTransformer.Extract(inJsonData)

	assert.Equal(t, transformedData, expectedTransformedData, "Extract data from json")
